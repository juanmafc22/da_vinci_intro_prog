Algoritmo Simulacro_parcial_1_modularizado
	...
	ejecutarAnalisis(acumKm, contadorGral, CANT_MAX_KM, contadorCuatoKm)
	
	
FinAlgoritmo


Funcion ejecutarAnalisis(acumKm, contadorGral, CANT_MAX_KM, contadorCuatoKm)
	// Hacemos el analisis
